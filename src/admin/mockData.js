...
export const mockAuditLogs = [
  { id: 1, timestamp: daysAgo(0), user: "admin@promptforge.com", action: "login", description: "Admin logged in to dashboard", ip: "192.168.1.1", userAgent: "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 Chrome/120.0.0.0", location: "New York, US", requestId: "req_abc123", metadata: { browser: "Chrome 120", os: "Windows 11" }},
  { id: 2, timestamp: daysAgo(0), user: "admin@promptforge.com", action: "user_updated", description: "Suspended user david.b@consulting.com for policy violation", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_def456", metadata: { targetUser: "david.b@consulting.com", reason: "Policy violation" }},
  { id: 3, timestamp: daysAgo(0), user: "admin@promptforge.com", action: "settings_updated", description: "Enabled feature flag: New Editor UI", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_ghi789", metadata: { flag: "new_editor_ui", previousValue: false, newValue: true }},
  ...
  { id: 6, timestamp: daysAgo(1), user: "admin@promptforge.com", action: "admin_action", description: "Deleted template: Code Review v1", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_pqr678", metadata: { templateId: 15 }},
  ...
  { id: 8, timestamp: daysAgo(1), user: "admin@promptforge.com", action: "admin_action", description: "Created coupon code SAVE20 (20% off, max 100 uses)", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_vwx234", metadata: { coupon: "SAVE20", discount: "20%", maxUses: 100 }},
  ...
  { id: 10, timestamp: daysAgo(2), user: "admin@promptforge.com", action: "api_key_rotated", description: "Rotated API key for OpenAI integration", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_bcd890", metadata: { provider: "OpenAI" }},
  ...
  { id: 15, timestamp: daysAgo(3), user: "admin@promptforge.com", action: "admin_action", description: "Updated rate limit for Free tier (50 → 30 requests/day)", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_qrs345", metadata: { from: 50, to: 30, unit: "requests/day" }},
  ...
  { id: 18, timestamp: daysAgo(4), user: "admin@promptforge.com", action: "user_created", description: "Invited new admin: newadmin@promptforge.com (Moderator role)", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_zab234", metadata: { email: "newadmin@promptforge.com", role: "Moderator" }},
  ...
  { id: 21, timestamp: daysAgo(5), user: "admin@promptforge.com", action: "admin_action", description: "Created new template: Research Summary (Research category)", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_ijk123", metadata: { template: "Research Summary", category: "Research" }},
  { id: 22, timestamp: daysAgo(6), user: "System", action: "settings_updated", description: "SSL certificate renewed for *.promptforge.com (valid until 2027-03-04)", ip: null, userAgent: null, location: "Cloudflare", requestId: "req_lmn456", metadata: { domain: "*.promptforge.com", validUntil: "2027-03-04" }},
  ...
  { id: 24, timestamp: daysAgo(7), user: "admin@promptforge.com", action: "settings_updated", description: "Enabled maintenance mode (2h for database upgrade)", ip: "192.168.1.1", userAgent: "Mozilla/5.0 Chrome/120.0.0.0", location: "New York, US", requestId: "req_rst012", metadata: { duration: "2h", reason: "Database upgrade" }},
...
export const mockNotifications = [
  ...
  { id: 10, title: "Welcome to PromptForge!", message: "Thanks for joining PromptForge! Get started with our quick tutorial and create your first AI-powered prompt.", audience: "all", channels: ["email"], status: "Sent", sentAt: daysAgo(30), recipients: 890, openRate: 72.1 },
];
...
export const mockAdminTeam = [
  { id: 1, name: "Super Admin", email: "admin@promptforge.com", role: "Super Admin", lastLogin: daysAgo(0), status: "Active" },
  { id: 2, name: "Jane Cooper", email: "jane.c@promptforge.com", role: "Admin", lastLogin: daysAgo(1), status: "Active" },
  { id: 3, name: "Mark Johnson", email: "mark.j@promptforge.com", role: "Moderator", lastLogin: daysAgo(3), status: "Active" },
];
...
export const mockCannedResponses = [
  { id: 1, title: "Thank You", text: "Thank you for reaching out to PromptForge support. We've received your ticket and will respond within 24 hours." },
