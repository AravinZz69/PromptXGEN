    ...
    <div className="bg-muted border border-border rounded-xl overflow-hidden">
      ...
      <div className="p-4 border-b border-border flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-semibold text-foreground">{gateway.display_name}</h3>
      ...
      <div className="p-4 space-y-4">
            ...
            <div key={field.key}>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-2 pr-10 bg-muted border border-border text-foreground placeholder-muted-foreground rounded-lg"
                />
                {field.secret && (
                  <button
                    type="button"
        ...
        {showCode && (
          <div className="relative">
            ...
            <button
              onClick={copyCode}
              className="absolute top-2 right-2 p-2 rounded bg-muted hover:bg-muted text-muted-foreground hover:text-foreground"
            >
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-3">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-muted border border-border text-foreground placeholder-muted-foreground rounded-lg"
          />
        </div>
      ...
      <AlertDialog open={!!refundItem} onOpenChange={() => setRefundItem(null)}>
        <AlertDialogContent className="bg-muted border-border">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-foreground">Process Refund?</AlertDialogTitle>
