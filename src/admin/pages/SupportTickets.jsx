              ...
              <div className="border-b border-border">
                ...
                <button
                  ...
                  className={`px-4 py-3 text-sm font-medium transition-colors ${
                    activeTab === tab.id
                      ? 'text-primary border-b-2 border-indigo-400'
            ...
            {filteredTickets.length === 0 ? (
              ...
              filteredTickets.map(ticket => (
                ...
                >
                  ...
                  <p className="text-sm text-muted-foreground line-clamp-2">{ticket.messages[0]?.text}</p>
            ...
            <>
              ...
              <div className="p-3 border-t border-border flex gap-2">
                <select
                  ...
                  className="px-2 py-1 bg-background border border-border rounded text-xs text-muted-foreground focus:outline-none"
                >
                ...
                <button
                  ...
                  className="px-2 py-1 bg-muted text-muted-foreground rounded text-xs hover:bg-muted"
                >
                  Assign
                </button>
              </div>
              ...
              <div className="p-4 border-t border-border">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {cannedResponses.slice(0, 3).map(resp => (
                      <button
                        ...
                        className="px-2 py-1 bg-muted text-muted-foreground rounded text-xs hover:bg-muted hover:text-white"
                      >
                        {resp.title}
                      </button>
                    ))}
                ...
                <div className="flex gap-2">
                  <textarea
                    ...
                    rows={2}
                    className="flex-1 px-3 py-2 bg-background border border-border rounded-lg text-white placeholder-muted-foreground text-sm focus:outline-none focus:border-primary resize-none"
                  />
                  <button
                    onClick={handleReply}
                    disabled={!replyText.trim()}
                    className="px-4 bg-primary text-white rounded-lg hover:bg-primary disabled:opacity-50 disabled:cursor-not-allowed"
                  >
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="px-4 py-3 text-left text-xs font-semibold text-muted-foreground uppercase">Response Text</th>
            ...
            <tbody>
              {cannedResponses.map(resp => (
                <tr key={resp.id} className="border-b border-border/50">
                  <td className="px-4 py-3 text-sm text-white font-medium">{resp.title}</td>
                  <td className="px-4 py-3 text-sm text-muted-foreground max-w-md truncate">{resp.text}</td>
                  <td className="px-4 py-3">
                    <button className="text-muted-foreground hover:text-white text-sm">Edit</button>
                  </td>
                </tr>
              ))}
            </tbody>
