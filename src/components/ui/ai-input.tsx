...
const injectStyles = () => {
  const styleId = "color-orb-styles"
...
export function MorphPanel({ onSubmit }: { onSubmit?: (message: string) => void }) {
        ...
        {showForm && (
          ...
          >
            ...
            <textarea
              ...
              className="h-full w-full resize-none scroll-py-2 rounded-md p-4 outline-0 bg-transparent"
              required
