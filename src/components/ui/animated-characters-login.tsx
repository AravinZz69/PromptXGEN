...
import { Eye, EyeOff, Mail, Zap, Github, Loader2, Lock } from "lucide-react";
...
export function AnimatedCharacters({ password, showPassword, isTyping }: AnimatedCharactersProps) {
  const [mouseX, setMouseX] = useState<number>(0);
  const [mouseY, setMouseY] = useState<number>(0);
...
export function AnimatedLoginPage({
  ...
  const config = { ...DEFAULT_LOGIN_CONFIG, ...propsConfig };
      ...
      <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <img src={config.logoUrl} alt={config.siteName} className="size-8" />
        ...
        <div className="relative z-20 flex items-center gap-8 text-sm text-primary-foreground/60">
          <a href="/terms?tab=privacy" className="hover:text-primary-foreground transition-colors">Privacy Policy</a>
      ...
      <div className="flex items-center justify-center p-8 bg-background">
        <div className="w-full max-w-[420px]">
          ...
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold tracking-tight mb-2">{config.heading}</h1>
          ...
          {/* Social Login */}
          {(config.showGoogleLogin || config.showGitHubLogin) && (
            <>
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-background px-2 text-muted-foreground">{config.orDividerText}</span>
                </div>
              </div>

              <div className={`grid gap-3 ${config.showGoogleLogin && config.showGitHubLogin ? 'grid-cols-2' : 'grid-cols-1'}`}>
