...
const Auth = () => {
  ...
  const handleLogin = async (emailInput: string, password: string) => {
    ...
    try {
      ...
      if (isAdminCredentials(emailInput, password)) {
        const result = adminLogin(emailInput, password);
        if (result.success) {
          toast({
            title: 'Welcome, Admin!',
          ...
          <div className="glass-card p-8">
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="text-primary hover:underline font-medium inline-flex items-center text-sm"
              >
